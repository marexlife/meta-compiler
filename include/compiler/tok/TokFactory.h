#ifndef COMPILER_TOK_FACTORY_H
#define COMPILER_TOK_FACTORY_H

#include "Tok.h"
#include "compiler/tok/types/F64.h"
#include "compiler/tok/types/Ident.h"
#include <memory>
#include <string_view>
...
public:
  [[nodiscard]] static auto newTok(const ::std::string_view name)
    ...
    if (name == "F64") {
      return ::std::make_unique<::compiler::tok::types::F64>();
    }
